...
7. Levantar backend con `PUERTO=3180 CORS_ORIGINS=http://localhost:4300 npm run dev`.
8. Entrar a `frontend/`.
9. Ejecutar `npm install`.
10. Levantar frontend con `npm start`.
11. Abrir `http://localhost:4300/login`.
12. Login: `Sistemas / Sistemas*2026`.
13. Revisar dashboard.
14. Abrir paquetes y buscar `APA-000001`.
